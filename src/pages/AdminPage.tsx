...
// 🧾 거래명세표 발급 컴포넌트 (필요할 때 수동으로 만들어서 인쇄/PDF 저장)
      ...
      <div id="invoice-printable" style={{ fontFamily: "'Malgun Gothic', sans-serif", color: '#000', fontSize: '9pt' }}>
        <div style={{ maxWidth: 820, margin: '0 auto', border: '2px solid #0000ff', padding: 8, background: '#fff' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', border: '1.5px solid #0000ff', marginBottom: 5, tableLayout: 'fixed' }}>
            <tbody>
              <tr>
                <td rowSpan={4} style={{ border: '1px solid #0000ff', writingMode: 'vertical-rl', textOrientation: 'upright', background: '#f0f4ff', fontWeight: 'bold', textAlign: 'center', width: 26 }}>공급자</td>
                ...
                <td rowSpan={4} style={{ border: '1px solid #0000ff', writingMode: 'vertical-rl', textOrientation: 'upright', background: '#f0f4ff', fontWeight: 'bold', textAlign: 'center', width: 26 }}>공급받는자</td>
                <th style={{ border: '1px solid #0000ff', background: '#f0f4ff', fontWeight: 'normal', fontSize: 8.5, padding: 4 }}>등록번호</th>
